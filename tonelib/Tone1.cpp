/* $Id: Tone1.cpp 119 2010-07-17 18:56:36Z bhagman@roguerobotics.com $
...
uint8_t Tone1::_tone_pin_count = 0;


void Tone1::begin(uint8_t tonePin)
{
...
void Tone1::play(uint16_t frequency, uint32_t duration)
{
